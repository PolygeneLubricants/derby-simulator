...
public class GallopDeck
{
    ...
    public IList<GallopCard> Deck { get; set; }
    ...
    private IList<GallopCard> Populate()
    {
        return new List<GallopCard>
        {
            ...
            new() { Title = "Hesten forceres", Description = "Flyt 4 felter ekstra frem." },
            new() { Title = "Hesten presses", Description = "Flyt et felt ekstra frem." },
            ...
            new() { Title = "Hesten går udemærket", Description = "Flyt 5 felter ekstra frem." },
            new() { Title = "Fin galop", Description = "Ryk to felter ekstra frem." },
            new() { Title = "Fin galop", Description = "Ryk to felter ekstra frem." },
            new() { Title = "Fin galop", Description = "Ryk to felter ekstra frem." },
            new() { Title = "Fin galop", Description = "Ryk to felter ekstra frem." },
            new() { Title = "Fin galop", Description = "Ryk to felter ekstra frem." },
